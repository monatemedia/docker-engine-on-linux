...
rm -- "$0"
ssh "${USER}@${vps_ip}" "rm /tmp/create-docker-publish-temp.sh"
...
echo
echo "scp ${USER}@${vps_ip}:$TEMP_SCRIPT ./create-docker-publish-temp.sh"
echo
echo "Then run:"
echo "./create-docker-publish-temp.sh"
echo
echo "Once the script finishes, it will delete itself from your project."
