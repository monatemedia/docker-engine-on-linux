...
echo
echo "This is an example module script that shows you how to:"
echo "  ✅ Create a menu section using:    # Menu: <section>"
echo "  ✅ Describe your script using:     # Description: <info>"
echo "  ✅ Add executable logic like this echo command"
echo
...
echo
echo "👉 Try running: denlin example/hello-world"
